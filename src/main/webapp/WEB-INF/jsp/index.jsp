    ...
    <div class="bs-component">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <p>
            Вы наверняка знаете, какие «прекрасные» очереди необходимо простоять на маршрутку, чтобы уехать на правый
            берег в утреннее время.
            Главная задача нашего сервиса – облегчить жизнь:
            Тому, кто добирается утром на работу на маршрутках.
            Больше Вам не нужно будет вставать на час раньше, чтобы простоять «Великую» очередь на маршрутку и уехать
            на правый берег.
          ...
          <p>
            ...
            высадки пассажиров на левом и правом берегах нашего города, что значительно облегчит Ваш поиск с выбором
            поездки.
            В случае, если у Вас есть авто, создавать поездки. При этом Вы сможете выбрать основные точки Вашего
            маршрута,
            задавать время старта, устанавливать количество свободных мест в каждой поездке, а также адекватную
            стоимость проезда.
            Благодаря этому Вы сможете не только окупить проезд на правый берег, но также помочь людям добраться
            вовремя на работу.
